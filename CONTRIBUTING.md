# Contributing to the School of Sustainability Wordpress Theme

Looking for a way to contribute to the Sustainability Wordpress Theme? **Here's how you can help.**

Please take a moment to review this document, as well as the web design standards set out by the [Hub](hub.asu.edu).

## Using the issue tracker

The [issue tracker](https://github.com/gios-asu/SoS-Wordpress-Theme/issues) is the preferred chabel for [bug reports](#bug-reports), [features requests](#feature-requests) and [submitting pull requests](#pull-requests), but please respect the following restrictions:
...
Run `grunt` before committing to ensure your changes follow our coding standards.


## License

By contributing your code, you agree to license your contribution under the [MIT license](https://github.com/gios-asu/SoS-Wordpress-Theme/blob/master/LICENSE).